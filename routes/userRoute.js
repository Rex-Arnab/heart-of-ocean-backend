...
app.get("/referral/:userId", userController.getUserByUserId);
...
app.post("/deposit", authController.verifyToken, authController.verifyAdmin, authController.verifyFundDepositPermission, userController.depositById);
